...
/*   Updated: 2024/10/14 16:14:19 by lle-pier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string &target)
{
    if (energyPoints < 1)
    {
        std::cout << "ClapTrap " << name << " can't attack, not enough energy!\n" << std::endl;
        return;
    }
    if (hitpoints < 1)
    {
        std::cout << "ClapTrap " << name << " can't attack, it's dead!\n" << std::endl;
        return;
    }
    energyPoints -= 1;
...
void ClapTrap::takeDamage(unsigned int amount)
{
    if (hitpoints < 1)
    {
        std::cout << "ClapTrap " << name << " can't take damage, it's dead!\n" << std::endl;
        return;
    }
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    {
        std::cout << "ClapTrap " << name << " can't be repaired, more than 100 hitpoints!\n" << std::endl;
        return;
    }
    if (energyPoints < 1)
    {
        std::cout << "ClapTrap " << name << " can't be repaired, not enough energy!\n" << std::endl;
        return;
    }
    if (hitpoints < 1)
    {
        std::cout << "ClapTrap " << name << " can't be repaired, it's dead!\n" << std::endl;
        return;
    }
    hitpoints += amount;
    energyPoints -= amount;
